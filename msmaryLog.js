document.addEventListener("DOMContentLoaded", function() {
    ...
    const msmaryLog = document.getElementById("msmaryLog");

    // Email validation
    function validateEmail(email) {
        return email.endsWith("@msmary.edu");
    }
    ...
    msmaryLog.addEventListener("submit", function(event) {
        ...
        .then(data => {
            ...
            setTimeout(() => {
                window.location.href = "msmary.html";
            }, 2000);
        })
        .catch(error => {
